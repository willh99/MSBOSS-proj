...
SYSCALL(shm_get) //mod2
     f75:	b8 1c 00 00 00       	mov    $0x1c,%eax
     f7a:	cd 40                	int    $0x40
     f7c:	c3                   	ret    

00000f7d <shm_rem>:
SYSCALL(shm_rem) //mod2
     f7d:	b8 1d 00 00 00       	mov    $0x1d,%eax
     f82:	cd 40                	int    $0x40
     f84:	c3                   	ret    

00000f85 <setHighPrio>:
SYSCALL(setHighPrio) //scheduler
     f85:	b8 1e 00 00 00       	mov    $0x1e,%eax
     f8a:	cd 40                	int    $0x40
     f8c:	c3                   	ret    

00000f8d <mutex_create>:
SYSCALL(mutex_create)//mod3
     f8d:	b8 16 00 00 00       	mov    $0x16,%eax
     f92:	cd 40                	int    $0x40
     f94:	c3                   	ret    

00000f95 <mutex_delete>:
SYSCALL(mutex_delete)
     f95:	b8 17 00 00 00       	mov    $0x17,%eax
     f9a:	cd 40                	int    $0x40
     f9c:	c3                   	ret    

00000f9d <mutex_lock>:
SYSCALL(mutex_lock)
     f9d:	b8 18 00 00 00       	mov    $0x18,%eax
     fa2:	cd 40                	int    $0x40
     fa4:	c3                   	ret    

00000fa5 <mutex_unlock>:
SYSCALL(mutex_unlock)
     fa5:	b8 19 00 00 00       	mov    $0x19,%eax
     faa:	cd 40                	int    $0x40
     fac:	c3                   	ret    

00000fad <cv_wait>:
SYSCALL(cv_wait)
     fad:	b8 1a 00 00 00       	mov    $0x1a,%eax
     fb2:	cd 40                	int    $0x40
     fb4:	c3                   	ret    

00000fb5 <cv_signal>:
SYSCALL(cv_signal)
     fb5:	b8 1b 00 00 00       	mov    $0x1b,%eax
     fba:	cd 40                	int    $0x40
     fbc:	c3                   	ret    
