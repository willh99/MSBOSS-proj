...
void ls(char *path)
{
 ...
 188:	e9 3f 01 00 00       	jmp    2cc <ls+0x214>
	...
	case T_DIR:
		//mkdir("test"); st.type=1 means its a directory
...
SYSCALL(shm_get) //mod2
 63d:	b8 1c 00 00 00       	mov    $0x1c,%eax
 642:	cd 40                	int    $0x40
 644:	c3                   	ret    

00000645 <shm_rem>:
SYSCALL(shm_rem) //mod2
 645:	b8 1d 00 00 00       	mov    $0x1d,%eax
 64a:	cd 40                	int    $0x40
 64c:	c3                   	ret    

0000064d <setHighPrio>:
SYSCALL(setHighPrio) //scheduler
 64d:	b8 1e 00 00 00       	mov    $0x1e,%eax
 652:	cd 40                	int    $0x40
 654:	c3                   	ret    

00000655 <mutex_create>:
SYSCALL(mutex_create)//mod3
 655:	b8 16 00 00 00       	mov    $0x16,%eax
 65a:	cd 40                	int    $0x40
 65c:	c3                   	ret    

0000065d <mutex_delete>:
