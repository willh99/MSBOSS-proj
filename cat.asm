...
SYSCALL(shm_get) //mod2
 406:	b8 1c 00 00 00       	mov    $0x1c,%eax
 40b:	cd 40                	int    $0x40
 40d:	c3                   	ret    

0000040e <shm_rem>:
SYSCALL(shm_rem) //mod2
 40e:	b8 1d 00 00 00       	mov    $0x1d,%eax
 413:	cd 40                	int    $0x40
 415:	c3                   	ret    

00000416 <setHighPrio>:
SYSCALL(setHighPrio) //scheduler
 416:	b8 1e 00 00 00       	mov    $0x1e,%eax
 41b:	cd 40                	int    $0x40
 41d:	c3                   	ret    

0000041e <mutex_create>:
SYSCALL(mutex_create)//mod3
 41e:	b8 16 00 00 00       	mov    $0x16,%eax
 423:	cd 40                	int    $0x40
 425:	c3                   	ret    

00000426 <mutex_delete>:
